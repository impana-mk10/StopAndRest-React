...
import { bookRoom, datesBooked, getRoomById } from "../utils/ApiFunctions";
...
const BookingForm = () => {
  ...
  const fetchBookedDates = async (roomId) => {
    try {
      const dates = await datesBooked(roomId);
  ...
  const isDateBooked = (date) => {
    return bookedDates.some((bookedDate) =>
      moment(bookedDate).isSame(date, "day")
    );
  };
      ...
      <div className="container mb-5">
        <div className="row">
          <div className="col-md-6">
            <div className="card card-body mt-5 booking-form-card card-shadow">
                  ...
                  <div className="row">
                    ...
                    <div className="col-6">
                      ...
                      <DatePicker
                        ...
                        dateFormat="MMMM d, yyyy"
                        minDate={booking.checkInDate || new Date()}
                        filterDate={(date) => !isDateBooked(date)}
                        className="form-control"
